<template>
  <div>
    <el-table :data="tableData" style="width: 100%" class="datatable">
      ...
      <el-table-column prop="productTotal" label="销售产品总价" width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteRow(index, row) {
      this.$confirm("此操作将出库该销售单, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          requestPost("api/main/stock/outstock", this.dellist)
            .then(resp => {
              console.log("响应的结果：", resp);
              this.info = resp.data;
